...
The rating should be a float between 1 and 5, rounded to two decimal places, with 1 representing very poor quality and 5 representing excellent quality. Think step by step about the perceptual quality of the image and return the final answer like: <answer> the score </answer>.
""".strip()
    ...
    dataset.push_to_hub("Coobiw/agiqa3k_simpleprompt_1027", private=False, token=True)
